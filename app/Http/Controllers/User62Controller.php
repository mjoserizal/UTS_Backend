...
class User62Controller extends Controller
{
    ...
    public function registerView62()
    {
    ...
    public function lupaPasswordView62()
    {
    ...
    public function lupaPassword62(Request $request)
    {
    ...
    public function tambahAgama62(Request $request)
    {
        $request->validate([
            'nama_agama' => 'required',
        ]);
    ...
    public function hapusAgama62(Request $req)
    {
    ...
    public function setIsAktif62(Request $req, $id)
    {
        $user = User::find($id);
    ...
    public function detailUser62($id)
    {
        $user = User::find($id);
    ...
    public function updateData62(Request $request)
    {
    ...
    public function register62(Request $req)
    {
        $req->validate([
            'name' => 'required',
    ...
    public function login62(Request $req)
    {
        $req->validate([
        ...
        if (!$user || !Hash::check($req->password, $user->password)) {
            ...
            return Redirect::to('/user/profile62');
        } else if ($user && $user->role == 2) {
            $allUser = User::all();
            $req->session()->put('admin', $user);
            $req->session()->put('users', $allUser);
            return Redirect::to('/admin/dashboard62');
        }
    }
