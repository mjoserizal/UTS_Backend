      ...
      <div class="card p-4">
        <div class="container bootstrap snippet">
          <div class="row">
            <!--/col-3-->
            <div class="col-sm-12">
              <form class="form" action="<?php echo e(url('/updateData62')); ?>" method="POST" enctype="multipart/form-data"
                id="registrationForm">
                <?php echo csrf_field(); ?>
                  ...
                  <div class="tab-pane active" id="home">
                    <div class="w-100 d-flex justify-content-center">
                      <label for="foto" class="text-center">
                        <img style="cursor: pointer;" src="<?php echo e(asset('img/' . $user->foto)); ?>" width="200px"
                          height="200px" class="rounded-circle" alt="foto profil" id="preview_foto">
                      </label>
                      <input type="file" name="foto" id="foto" value="<?php echo e($user->foto); ?>" hidden>
                    </div>
                    <div class="form-group">
                      <div class="col-xs-6">
                        ...
                        <input type="text" class="form-control" name="name" id="first_name"
                          placeholder="Nama lengkap anda" value="<?php echo e($user->name); ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-xs-6">
                        ...
                        <input type="text" class="form-control" name="email" id="email"
                          placeholder="user@example.com" value="<?php echo e($user->email); ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-xs-6">
                    ...
                    <div class="form-group">
                      <div class="col-xs-6">
                        ...
                        <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir"
                          placeholder="Tempat lahir anda" value="<?php echo e($detailUser->tempat_lahir); ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-xs-6">
                    ...
                    ">
                        ...
                        <select name="agama_id" id="agama_id" class="form-control">
                          <?php $__currentLoopData = $agamas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agama): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($agama->id); ?>"
                              <?php echo e($detailUser->agama_id == $agama->id ? 'selected' : ''); ?>>
                              <?php echo e($agama->nama_agama); ?></option>
                      ...
                      <div class="form-group">
                        <div class="col-xs-6">
                          ...
                          <input type="file" class="form-control" value="<?php echo e($detailUser->foto_ktp); ?>" id="foto_ktp"
                            name="foto_ktp">
                      ...
                      <a href="<?php echo e(url('/user/lupaPassword62')); ?>" class="text-primary">Lupa password</a>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/user/index.blade.php ENDPATH**/ ?>